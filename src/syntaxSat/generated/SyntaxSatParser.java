...
public class SyntaxSatParser extends Parser {
	...
	public static class CommandesContext extends ParserRuleContext {
		public List<TerminalNode> Commande() { return getTokens(SyntaxSatParser.Commande); }
		public TerminalNode Commande(int i) {
			return getToken(SyntaxSatParser.Commande, i);
		}
